        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center gap-5 px-6">
            <motion.h1
              ...
              className="font-editorial italic text-6xl md:text-7xl text-white tracking-tight"
            >
              owlighting
            </motion.h1>
            ...
            <motion.div
              ...
              className="h-px w-24 bg-text-tertiary/40"
            />
            ...
            <motion.p
              ...
              className="font-mono-tech text-[10px] uppercase tracking-[0.4em] text-text-tertiary"
            >
              EST · 2019 · WAY JEPARA
            </motion.p>
          </div>
