...
import { FaTiktok, FaEye, FaPlay } from "react-icons/fa";
        ...
        <div className="max-w-7xl mx-auto">
          {loading ? (
            <div className="text-center py-20">
              ...
              <p className="text-muted mt-4">Loading videos...</p>
            </div>
              ...
              {filteredVideos.map((video, index) => (
                <AnimatedSection key={video.id} delay={index * 0.1}>
                  <a
                    ...
                    className="group block glass rounded-xl overflow-hidden hover:glow-primary transition-all duration-300"
                  >
                    {/* Thumbnail */}
                    <div className="relative aspect-9/16 bg-surface overflow-hidden">
                      {video.thumbnail_url ? (
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-linear-to-br from-primary/20 to-cyan-500/20">
                          <FaTiktok className="text-6xl text-primary/40" />
                        </div>
                      )}
                      ...
                      <div className="absolute top-4 left-4">
                        <span className="px-3 py-1 bg-black/70 backdrop-blur-sm rounded-full text-xs font-bold border border-primary/30">
                          {video.category}
                        </span>
                      </div>
                      ...
                      {video.views && (
                        <div className="absolute bottom-4 right-4">
                          <div className="flex items-center gap-1 px-3 py-1 bg-black/70 backdrop-blur-sm rounded-full text-xs font-bold">
